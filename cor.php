...
<div class="mwrap">    
    ...
    <div id="sidebar">
    	...
    	<ul>
             ...
             <a href='searchterm.php'><li>Back</li></a>
    ...
    <div id="mainbar">
    <h3><?php $term=trim($_POST['term']);
				$level=trim($_POST['level']);
				 $sql=mysqli_query($link,"SELECT * FROM level WHERE level='$level' and slevel='$term'");
