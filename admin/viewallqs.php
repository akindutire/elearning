...
<div class="mwrap">    
    ...
    <div id="sidebar">
    	...
    	<ul>
             ...
             <!--<a id="export" onclick="javascript:exportpdf()"><li><img src="../images/export.png" width="auto" height="25px" title="Export PDF">Export PDF</li></a>-->
             
             <a id="export" onclick="window.print()"><li>Print</li></a>
        </ul>
