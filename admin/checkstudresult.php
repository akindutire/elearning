    ...
    <div id="header">
    	<div class="inheader">
        	<div id="left">
            	...
            	<img src=<?php echo LA; ?> width="45px" height="auto" vspace="-2px" hspace="-2px">&nbsp;<span style="font-size:32px;"><?php echo E; ?></span>
...
<div class="mwrap">    
    ...
    <h3>Result</h3>
        ...
        <div id="tab_cont">
            ...
            <?php	 $cp->curterm($_POST['stud'],$_POST['level'],$_POST['term']);	?>
