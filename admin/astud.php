...
<div class="mwrap">    
	...
	<form method="post" action="../process/iaskl.php" enctype="multipart/form-data" id="asd">
			
             
             <div class="all"><label>Name</label>
             <input type="text" name="sdname" id="sdname"  required="required">
             </div>
             
			
             <div class="all"><label>Tel.</label>
             <input type="text" name="sdtel" id="sdtel" required="required">
             </div>
               
               
                <div class="all"><label>Level</label>
             <select name="level" id='ilv'>
            ...
            <!-- <div class="all"><label>Text</label>
             ...
             -->
             <div class="all"><label></label><button type="submit" id="sdreg">Enter</button></div>
    </form>
