...
<div class="mwrap">    
	...
	<form method="post" action="../process/sskl.php" style="width:100%;">
             ...
             <input type="text" name="tutname" placeholder="Tutor Mail" id="tutname" style="width:90%;">
             </div>
        ...
        <div id="feedback" style="background:transparent; color:black; font-family:'Browallia New'; font-size:18px; padding:1px; margin:8px 0px 2px 140px; height:auto; width:350px; text-align:center; border-radius:3px;"></div>	
                <p style="color:green; font-size:10px; cursor:alias;">
                    ...
                    <center>
                         ...
                         <a id="addstud" href="atut.php" target="_new"><img src="../images/addtut.png" width="75px" height="auto"></a>
       &nbsp;&nbsp;&nbsp;
    	                <a id="locktut"><img src="../images/locked.jpg" width="75px" height="auto"></a>
       &nbsp;&nbsp;&nbsp;
    	                <a id="unlocktut" target="_new"><img src="../images/unlocked.jpg" width="75px" height="auto"></a>
       &nbsp;&nbsp;&nbsp;
