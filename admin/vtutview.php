...
<div class="mwrap">    
	...
	<form method="post" action="../process/sskl.php" style="width:100%;">
             ...
             <div class="all" style="width:100%;"><label>Student Name</label>
             <input type="text" name="sdname" id="sdname"  required="required" style="width:70%;">
             </div>
        ...
        <div id="tab_cont">
        	<table border="1" cellspacing="0" cellpadding="8px" style="padding:2px; background:transparent; border:0px; width:100%;">
              
            <?php	@$cp->vstudtutview($val);	?>
