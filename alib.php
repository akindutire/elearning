...
<div class="mwrap">    
	...
	<form method="post" action="uprocess/sskl.php" style="width:100%;">
			             
             <div class="all" style="width:100%;"><label>Search Library</label>
            	 <input type="text" name="bkname" id="ibkname" placeholder="Search Library"style="width:90%;">
             </div>
